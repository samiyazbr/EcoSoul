...
export type WalletGetCallsStatusReturnType<capabilities extends WalletCapabilities = WalletCapabilities, numberType = Hex, bigintType = Hex, receiptStatus = Hex> = {
    atomic: boolean;
...
export type WalletSendCallsReturnType<capabilities extends WalletCapabilities = WalletCapabilities> = {
